...
function jsvm_this_run(E, e) {
    ...
    for (var r = 3; void 0 !== r; )
        ...
        case 5:
            ...
            break;
        case 6:
            var j, f, g, D, w, M, G, y, A, U = 0;
            switch (127 & (j = jsvm_this_insns[v])) {
            case 26:
                U = 1,
                D = j >> 12 & 4095,
                w = (f = jsvm_this_insns[v + 1]) >> 0 & 31,
                t[g = j >> 7 & 31][D] = t[w];
                break;
            case 21:
                D = j >> 12 & 31,
            ...
            case 64:
                D = j >> 12 & 31,
                w = j >> 17 & 31,
                t[g = j >> 7 & 31] = s(t[D] + t[w]);
                break;
            case 96:
                U = 1,
                D = j >> 12 & 31,
                w = j >> 17 & 127,
                w |= ((f = jsvm_this_insns[v + 1]) >> 0 & 511) << 7,
                t[g = j >> 7 & 31] = s(t[D] + w);
                break;
            case 16:
                D = j >> 12 & 255,
                t[g = j >> 7 & 31] = 2 == D ? +t[g] : 0 == D ? {} : 1 == D ? [] : void 0;
                break;
            case 32:
                U = 1,
                D = j >> 12 & 4095,
                D |= ((f = jsvm_this_insns[v + 1]) >> 0 & 15) << 12,
                t[g = j >> 7 & 31] = D;
                break;
            case 48:
                U = 1,
                D = j >> 12 & 4095,
                D = (D |= ((f = jsvm_this_insns[v + 1]) >> 0 & 15) << 12) << 16 >> 16,
                t[g = j >> 7 & 31] = D;
                break;
            case 80:
                U = 1,
                D = j >> 23 & 1,
                a((g = j >> 7 & 65535) + (w = (f = jsvm_this_insns[v + 1]) >> 4 & 65535), t[D |= (f >> 0 & 15) << 1]);
                break;
            case 8:
                U = 1,
                g = j >> 7 & 31,
            ...
            case 20:
                U = 1,
                D = j >> 23 & 1,
                D |= ((f = jsvm_this_insns[v + 1]) >> 0 & 15) << 1,
                a((g = j >> 7 & 65535) + t[w = f >> 4 & 31], t[D]);
                break;
            case 84:
            case 52:
                g = (g = j >> 7 & 65535) << 16 >> 16,
            ...
            case 66:
                g = j >> 7 & 31,
                jsvm_this_tmpValue = t[D = j >> 12 & 31],
            ...
            case 90:
                ...
                D = j >> 12 & 31,
                w = j >> 17 & 127,
                w |= ((f = jsvm_this_insns[v + 1]) >> 0 & 31) << 7,
                t[g = j >> 7 & 31] = t[D][w];
                break;
            case 6:
                U = 1,
            ...
            case 121:
                ...
                D |= ((f = jsvm_this_insns[v + 1]) >> 0 & 15) << 12,
                w = f >> 4 & 255,
                "number" == typeof t[g = j >> 7 & 31].jsvmfunc) {
                    for (u = 1; u <= w; u++)
                        V.push(s(D + u));
                    m = !0,
                    n.push(s(D)),
            ...
            case 37:
                ...
                g = j >> 7 & 65535,
                D = j >> 23 & 1,
                D |= ((f = jsvm_this_insns[v + 1]) >> 0 & 32767) << 1,
                u = 1; u <= D; u++)
                    a(g + D - u, n.pop());
                break;
            case 101:
...
// var a = generate(undefined, undefined, 1622628350032)
