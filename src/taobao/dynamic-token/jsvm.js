...
!(function (require, exports, module) {
  !function () {
    function jsvm_this_initialization(E) {
      for (var e = 5; void 0 !== e; ) switch (e % 10) {
        case 0:
          !function (s, n) {
            switch (e / 10 | 0) {
              case 0:
      ...
      function jsvm_this_run(E, e) {
        ...
        for (var r = 3; void 0 !== r; ) switch (r % 7) {
          case 0:
            !function (E, s) {
              switch (r / 7 | 0) {
                case 0:
            ...
            switch (127 & (f = jsvm_this_insns[v])) {
              ...
              case 8:
                ...
                try {
                  ...
                  if (k = !0, null == (v = H.pop())) break;
                  - 1 === v && (v = H.pop()),
                  2 === l && (l = H.pop(), - 1 === (v = H.pop()) && (n.pop(), v = H.pop())),
                  d = 3 + l,
                  l = (l + 1) % 3,
                  t[0] = E
                }
              ...
              case 104:
                ...
                A = j >> 13 & 31;
                try {
                  if (0 === _) t[g] = 31 === D ? t[w](t[M], t[G], t[y], t[A])  : t[D][t[w]](t[M], t[G], t[y], t[A]);
                   else {
                    for (o = [
                    ], h = 31 == D ? void 0 : t[D], o.push(t[M]), o.push(t[G]), o.push(t[y]), o.push(t[A]), b = [
                    ], u = 0; u < _; u++) b.push(n.pop());
                    for (u = 0; u < _; u++) o.push(b.pop());
              ...
              case 122:
                ...
                break;
              case 38:
                if (U = 1, g = (g = f >> 7 & 65535) << 16 >> 16, D = f >> 23 & 1, D |= ((j = jsvm_this_insns[v + 1]) >> 0 & 15) << 1, n.length <= g) break;
                n[n.length - 1 - g] = t[D];
                break;
              case 22:
                if (g = f >> 7 & 31, D = f >> 12 & 31, n.length <= t[D]) break;
                t[g] = n[n.length - 1 - t[D]];
                break;
              case 86:
                if (g = f >> 7 & 31, D = f >> 12 & 31, n.length <= t[g]) break;
                n[n.length - 1 - t[g]] = t[D];
                break;
              case 54:
                if (D = f >> 12 & 31, w = f >> 17 & 31, void 0 === t[g = f >> 7 & 31]) jsvm_this_tmpValue = t[w],
              ...
              case 41:
                ...
                break;
              case 73:
                if (U = 1, g = f >> 7 & 31, D = f >> 12 & 4095, D = (D |= ((j = jsvm_this_insns[v + 1]) >> 0 & 15) << 12) << 16 >> 16, n.length <= D) break;
                t[g] = n[n.length - 1 - D];
                break;
              case 105:
                U = 1,
              ...
              case 57:
                ...
                break;
              case 121:
                if (U = 1, D = f >> 12 & 4095, D |= ((j = jsvm_this_insns[v + 1]) >> 0 & 15) << 12, w = j >> 4 & 255, 'number' == typeof t[g = f >> 7 & 31].jsvmfunc) {
                  for (u = 1; u <= w; u++) V.push(s(D + u));
                  m = !0,
                  n.push(s(D)),
                  k = !0,
                  n.push(v + 1 + U),
                  ...
                  for (o = [
                  ], h = s(D), u = 0; u < w; u++) o.push(s(D + w - u));
              ...
              case 25:
                ...
                break;
              case 69:
                if (g = f >> 7 & 255, m) for (u = 0; u < g; u++) n.push(V.pop());
                V = [
                ],
                m = !1;
                break;
              case 37:
                for (U = 1, g = f >> 7 & 65535, D = f >> 23 & 1, D |= ((j = jsvm_this_insns[v + 1]) >> 0 & 32767) << 1, u = 1; u <= D; u++) a(g + D - u, n.pop());
                break;
              case 101:
                D = f >> 12 & 31,
                w = f >> 17 & 31,
                ...
                break;
              case 5:
                for (U = 1, g = f >> 7 & 65535, D = f >> 23 & 1, D |= ((j = jsvm_this_insns[v + 1]) >> 0 & 32767) << 1, u = 0; u < D; u++) n.push(s(g + u));
                break;
              default:
                for (g = f >> 7 & 255, u = 0; u < g; u++) n.push(i.pop())
            }
            r = - 1 === v ? 0 : 21
          }
        }
...
// console.log(args)
// res=xxx('15859054881100-3118463136423031335',3,1585906186315)
// console.log(res)

// console.log(xxx(args[0],parseInt(args[1]),parseInt(args[2])))
